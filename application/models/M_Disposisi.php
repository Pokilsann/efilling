...
class M_Disposisi extends CI_Model
{
  ...
  public function get_tambahan(){
    return $this->db->query("SELECT *, disposisi.TANGGAL as disposisi_TANGGAL, surat.TANGGAL as SURAT_TANGGAL from disposisi
    INNER JOIN surat ON surat.ID_SURAT = disposisi.ID_SURAT")->result();
}
